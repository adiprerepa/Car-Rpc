...
class CarCommandRpcTask(activity: Activity): AsyncTask<ControlRequest, Void, ControlResponse>() {
     ...
     */
    override fun doInBackground(request: ControlRequest?): ControlResponse {
        val host: String? = request.ge
